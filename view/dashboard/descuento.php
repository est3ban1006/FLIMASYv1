                        ...
                        <tr>
                            ...
                            <td style="width: 33%;">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" name="porcentaje" id="porcentaje" placeholder="Porcentaje"  value="<?php echo $currentPerson->getApellido2();?>">
                                </div>
                            </td>
                            <td style="width: 33%;">
                                <div class="form-group ">
                                    <label for="valor" class="col-form-label">Valor</label><br>
                                    <input type="text" class="form-control" name="valor" id="valor" placeholder="Valor"  value="<?php echo $currentPerson->getApellido2();?>">
                                </div>
                            </td>  
                        </tr>
                    </table>
