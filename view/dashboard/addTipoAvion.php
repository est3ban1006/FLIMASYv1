                        ...
                        <tr>
                            <td style="width: 33%;">
                                <div class="form-group ">
                                    ...
                                    <input type="number" class="form-control" name="año" id="año" placeholder="Año" value="<?php echo $newAno;?>">
                                </div>
                                <div class="form-group ">
                                    <label for="modelo" class="col-form-label">Modelo</label><br>
                                    <input type="text" class="form-control" name="modelo" id="modelo" placeholder="Modelo"  value="<?php echo $newModel;?>">
                                </div>
                            </td>
                            <td style="width: 33%;">
                                <div class="form-group ">
                                    <label for="marca" class="col-form-label">Marca</label><br>
                                    <input type="text" class="form-control" name="marca" id="marca" placeholder="Marca"  value="<?php echo $newMarca;?>">
                                </div>
                                <div class="form-group ">
                            ...
                            <td style="width: 33%;">
                                <div class="form-group ">
                                    ...
                                    <input type="number" class="form-control" name="cantAsientos" id="cantAsientos" placeholder="Cantidad de Asientos" min="6" max="9" value="<?php echo $newCantAsientos;?>">
                                </div> 
                                <div class="form-group ">
                                    <label for="cantpasajeros" class="col-form-label">Cantidad de Pasajeros</label><br>
                                    <input type="number" class="form-control" name="cantpasajeros" id="cantpasajeros" placeholder="Cantidad de Pasajeros"  value="<?php echo $newPasajeros;?>">
                                </div> 
                            </td>
                        </tr>
                    </table>
