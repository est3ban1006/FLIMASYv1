                      ...
                      <tbody>
                        <?php foreach ($listaArchivos as $file) { ?>
                            <tr>
                                ...
                                <td><a target="_blank" href="<?php echo $file['Ruta'];?>" download="<?php echo $file['Ruta'];?>" class="btn btn-sm btn-info" >Ver</a> <button type="button" class="btn btn-sm btn-danger" onclick="ConfirmDeleteArchivo(<?php echo $file[0]; ?>);">Eliminar</button></td>
                            </tr>
                        <?php } ?>
                      </tbody>
                      <tfoot>
