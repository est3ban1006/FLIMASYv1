                        ...
                        <?php foreach ($listaRutas as $staffRuta) { 
                          ...
                          ?>
                            <tr>
                                ...
                                <td><a href="editRuta.php?id=<?php echo $staffRuta["idRuta"]; ?>" type="button" class="btn btn-sm btn-info">Editar</a> <?php if($count == 0){ ?><button type="button" class="btn btn-sm btn-danger" onclick="ConfirmDeleteRuta(<?php echo $staffRuta["idRuta"]; ?>);">Eliminar</button> <?php } ?></td>
                            </tr>
                        <?php } ?>
                      </tbody>
                      <tfoot>
